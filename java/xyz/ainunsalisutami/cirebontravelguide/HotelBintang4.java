...
public class HotelBintang4 extends Activity {

    private Context context;
    private static final String TAG = HotelBintang4.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_bintang4);
    ...
    class LoadHotel extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(HotelBintang4.this);
        ...
        protected String doInBackground(String... args) {
            ...
            json = jsonParser.makeHttpRequest(AppConfig.URL_HOTEL_BINTANG4, "POST",
                    params);
