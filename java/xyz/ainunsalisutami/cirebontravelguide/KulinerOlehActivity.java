...
public class KulinerOlehActivity extends Activity {
    private Context context;
    private static final String TAG = KulinerOlehActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuliner_oleh);
    ...
    class LoadKuliner extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(KulinerOlehActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            json = jsonParser.makeHttpRequest(AppConfig.URL_KULINER_OLEH, "POST",
                    params);
