...
public class HotelBintang1 extends Activity {

    private Context context;
    private static final String TAG = HotelBintang1.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_bintang1);
    ...
    class LoadHotel extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(HotelBintang1.this);
        ...
        protected String doInBackground(String... args) {
            ...
            json = jsonParser.makeHttpRequest(AppConfig.URL_HOTEL_BINTANG1, "POST",
                    params);
