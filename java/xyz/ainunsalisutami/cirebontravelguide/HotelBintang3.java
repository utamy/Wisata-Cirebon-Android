...
public class HotelBintang3 extends Activity {

    private Context context;
    private static final String TAG = HotelBintang3.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_bintang3);
    ...
    class LoadHotel extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(HotelBintang3.this);
        ...
        protected String doInBackground(String... args) {
            ...
            json = jsonParser.makeHttpRequest(AppConfig.URL_HOTEL_BINTANG3, "POST",
                    params);
