...
public class WisataReligiActivity extends Activity {

    private Context context;
    private static final String TAG = WisataReligiActivity.class.getSimpleName();
    ...
    class LoadWisata extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(WisataReligiActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            json = jsonParser.makeHttpRequest(AppConfig.URL_WISATA_RELIGI, "POST",
                    params);
