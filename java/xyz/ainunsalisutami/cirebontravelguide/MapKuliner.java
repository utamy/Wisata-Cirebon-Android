...
public class MapKuliner extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_kuliner);
        ...
        Toast.makeText(MapKuliner.this, String.valueOf(latitude)+" "+String.valueOf(longitude), Toast.LENGTH_SHORT).show();
