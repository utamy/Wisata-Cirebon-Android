...
public class WisataSeniKerajinanActivity extends Activity {

    private Context context;
    private static final String TAG = WisataSeniKerajinanActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wisata_seni_kerajinan);
    ...
    class LoadWisata extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(WisataSeniKerajinanActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            json = jsonParser.makeHttpRequest(AppConfig.URL_WISATA_SENI, "POST",
                    params);
