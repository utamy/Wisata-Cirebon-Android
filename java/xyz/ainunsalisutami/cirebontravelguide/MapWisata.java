...
public class MapWisata extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alamat = i.getStringExtra("alamat_wisata");
        latitude = Double.valueOf(i.getStringExtra("lat"));
        longitude = Double.valueOf(i.getStringExtra("lng"));

        Toast.makeText(MapWisata.this, String.valueOf(latitude)+" "+String.valueOf(longitude), Toast.LENGTH_SHORT).show();
