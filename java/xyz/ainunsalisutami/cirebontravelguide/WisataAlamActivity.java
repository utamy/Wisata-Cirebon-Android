...
public class WisataAlamActivity extends Activity {
    ...
    class LoadWisata extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(WisataAlamActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            json = jsonParser.makeHttpRequest(AppConfig.URL_WISATA_ALAM, "POST",
                    params);
